...
public class Constants {
    ...
    public static final String TIME_1 = "TimeOne";
    public static final String TIME_2 = "TimeTwo";
    public static final String TIME_3 = "TimeThree";
    public static final String TIME_4 = "TimeFour";
